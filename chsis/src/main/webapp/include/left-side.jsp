...
<div class="left-side sticky-left-side">
	...
	<div class="left-side-inner">
		...
		<ul class="nav nav-pills nav-stacked custom-nav">
			...
			<li><a href="manager/manageFamily.jsp"><i class="fa fa-home"></i> <span>管理家庭</span></a></li>
			<li><a href="manager/manageResident.jsp"><i class="fa fa-home"></i> <span>管理居民</span></a></li>
