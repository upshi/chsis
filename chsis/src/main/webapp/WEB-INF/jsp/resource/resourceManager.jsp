...
<link href="assets/css/resourceManager.css" rel="stylesheet" type="text/css">
</head>
			...
			<div class="col-lg-12">
				...
				<header class="panel-heading"> 资源管理 </header>
					<div class="panel-body">
						...
						<div class="row">
							<br>
							<sec:authorize access="hasRole('ROLE_dea03d511a7a470c8e3b29371cbad975')">	
								<div class="col-lg-2" >
									<a href="resource/toAddResource" class="btn btn-warning" type="button">+添加新资源</a>
								</div>
							</sec:authorize>
							<sec:authorize access="hasRole('ROLE_a883794101534211a07a472049976dea')">	
													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu" style="min-width: 60px">
																<sec:authorize access="hasRole('ROLE_865a187479ae4c0ba3ded31c2682a659')">	
																	<li><a href="resource/detail/${resource.uuid }">详情</a></li>
																</sec:authorize>
																<sec:authorize access="hasRole('ROLE_c62d9751a16c415aba445d21fb50e25a')">	
																	<li><a href="resource/toUpdate/${resource.uuid }">编辑</a></li>
																</sec:authorize>
																<sec:authorize access="hasRole('ROLE_d58abd8fd7d146bda0aa8a3ecd186915')">	
