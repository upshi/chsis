...
<link href="static/css/addResource.css" rel="stylesheet" type="text/css">
</head>
<body class="sticky-header">
						...
						<div class="panel-body">
							<form id="form" class="form-horizontal" method="post" action="resource/addResource" role="form">
								...
								<div class="panel-body">
									...
									<sec:authorize access="hasRole('ROLE_cedf74876ea046b2aa05c8242bf4a472')">	
	...
	<!-- Custom JS -->
	<script src="assets/js/resource/addResource.js"></script>
</body>
